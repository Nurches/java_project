    ...
    public static void main(String[] args) {
        try {
            ...
            system.getTopCitedResearcherBySchool("Engineering")
                    .ifPresent(r -> System.out.println("Top cited researcher in Engineering citations=" + r.getTotalCitations()));

            system.getTopCitedResearcherOfCurrentYear()
                    .ifPresent(r -> System.out.println("Top cited researcher of current year citations=" + r.getTotalCitations()));
